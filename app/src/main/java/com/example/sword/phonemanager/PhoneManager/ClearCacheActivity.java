...
import com.example.sword.phonemanager.bean.AppCacheInfo;
import com.example.sword.phonemanager.bean.AppInfo;
import com.example.sword.phonemanager.utils.PackageUtils;
        ...
        public void onGetStatsCompleted(PackageStats stats, boolean succeeded) {
            ...
            if (cacheSize>12288){
                ...
                try {
                    ...
                    AppCacheInfo cacheInfo  = new AppCacheInfo(name.toString(),cacheSize,icon);
